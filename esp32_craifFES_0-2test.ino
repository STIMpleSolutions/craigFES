...
void setup() {
  ...
  tft.setCursor((320-13)/2, (240/2));
  tft.fillScreen(ILI9341_BLACK);
  tft.setTextColor(ILI9341_ORANGE);
  tft.setTextSize(3);
  tft.print("Placeholder welcome screen");
...
void startStopStim(){
  if(onOff){
    ...
    ledcWrite(pwmchan1, dutyCycle1); // writes the pwm channel with the value stored in dutyCycle1 (channel 1 stim)
